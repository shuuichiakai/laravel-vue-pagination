...
// CONCATENATED MODULE: ./src/LaravelVuePagination.vue?vue&type=template&id=68442dd7&
...
/* harmony default export */ var RenderlessLaravelVuePaginationvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    selectPage: function selectPage(page, type) {
      if (page === '...') {
        return;
      }
